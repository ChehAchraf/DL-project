    ...
    <header class="bg-white dark:bg-gray-800 shadow-md py-6 px-32">
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <!-- Filter Dropdown -->
                <div class="relative">
                    <select class="appearance-none w-48 px-4 py-2 border rounded-full 
                                   bg-white dark:bg-gray-700 
                                   text-gray-800 dark:text-gray-200
                                   border-gray-300 dark:border-gray-600
                                   focus:outline-none focus:ring-2 focus:ring-blue-500">
    ...
    <main class="container mx-auto px-32 py-12">
        <div class="grid md:grid-cols-3 gap-8">
            ...
            transform transition hover:scale-105 hover:shadow-xl">
                <div class="relative">
                    <img
                        src="https://ferrari-view.thron.com/api/xcontents/resources/delivery/getThumbnail/ferrari/0x0/61180ad6-702e-4700-a6a6-9bdb9d05d905.jpg?v=121"
                        alt="Luxury Sedan"
                ...
                <div class="p-6">
                    <div class="flex justify-between items-center mb-3">
                        <h3 class="text-2xl font-bold text-gray-800 dark:text-white">Toyota Camry</h3>
                    ...
                    <div class="mb-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-gray-800 dark:text-gray-200 font-semibold">35,000 miles</span>
                        </div>
                        <div class="flex justify-between items-center mt-2">
                            <span class="text-gray-600 dark:text-gray-300">Condition</span>
